...
class UserDetailScreen extends StatefulWidget {
  ...
  const UserDetailScreen({super.key, required this.user, required this.isEdit});
                ...
                ElevatedButton(
                  onPressed: () async {
                    if (_formKey.currentState!.validate()) {
                      ...
                      try {
                        await DatabaseHelper.instance.updateUser(widget.user.id!, updatedUser.toMap()); // Thay bằng DatabaseHelper
