...
class f8_form_scroll_view extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _FormBasicDemoState();
}

class _FormBasicDemoState extends State<f8_form_scroll_view> {
              ...
              children: [
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    errorText: _isSubmitted && (_confirmPasswordController.text.isEmpty)
